...
def eval_detections(detections, scores, file_names, ground_truth_path):
    ...
    print(rec,prec,average_precision)
    plt.plot(rec, prec, '-')
    plt.xlabel('Recall')
...
# CHANGED: Using parameters.py paths instead of hardcoded ones

# Define the root for Ground Truth
ground_truth_path_root = parameters.VALIDATION_DATA_DIR + os.sep

# --- TASK 1 ---
solution_path = parameters.TASK1_DIR + os.sep
...
# --- TASK 2 ---
solution_path = parameters.TASK2_DIR + os.sep
